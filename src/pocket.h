...
PKRes pk_push_string(Pocket lisp, char *cstr);
PKRes pk_push_stringn(Pocket lisp, char *string, size_t length);
PKRes PK_PRINTF(2, 3) pk_push_printf(Pocket lisp, const char *fmt, ...);
PKRes pk_push_symbol(Pocket lisp, char *csym);
PKRes pk_push_symboln(Pocket lisp, char *symbol, size_t length);
