...
PK_RES pk_fn_hexdump(void *user_closure, Pocket lisp) {
    PKAtom* atom = NULL;
    ...
    pk_try(pk_dump_hex_string(lisp, lfunc, &result));
    pk_try(pk_push(lisp, (PKAtom *)result));
...
PK_RES pk_load_std(Pocket lisp) {
    ...
    PKFuncRecord lib[PK_STD_LIB_COUNT] = {
        ...
        {"/", pk_fn_div, 2, PK_ARITY_VARIADIC, NULL},
        {"list-vars", pk_fn_list_vars, 0, PK_ARITY_NORMAL, NULL},
        {"list-funs", pk_fn_list_funs, 0, PK_ARITY_NORMAL, NULL},
        {"slurp", pk_fn_slurp, 1, PK_ARITY_NORMAL, NULL},
        ...
        {"set", pk_fn_set, 2, PK_ARITY_NORMAL, NULL},
        {"get", pk_fn_get, 1, PK_ARITY_NORMAL, NULL},
        {"unbind", pk_fn_unbind, 1, PK_ARITY_NORMAL, NULL},
        {"fset", pk_fn_fset, 2, PK_ARITY_NORMAL, NULL},
        {"fget", pk_fn_fget, 1, PK_ARITY_NORMAL, NULL},
        {"funbind", pk_fn_funbind, 1, PK_ARITY_NORMAL, NULL},
        {"car", pk_fn_car, 1, PK_ARITY_NORMAL, NULL},
        {"cdr", pk_fn_cdr, 1, PK_ARITY_NORMAL, NULL},
        {"set-car", pk_fn_set_car, 2, PK_ARITY_NORMAL, NULL},
        {"set-cdr", pk_fn_set_cdr, 2, PK_ARITY_NORMAL, NULL},
        {">", pk_fn_gt, 2, PK_ARITY_VARIADIC, NULL},
        {">=", pk_fn_gte, 2, PK_ARITY_VARIADIC, NULL},
        {"<", pk_fn_lt, 2, PK_ARITY_VARIADIC, NULL},
        ...
        {"clone", pk_fn_clone, 1, PK_ARITY_NORMAL, NULL},
        
        {"nil?", pk_fn_nil_p, 1, PK_ARITY_NORMAL, NULL},
        {"number?", pk_fn_num_p, 1, PK_ARITY_NORMAL, NULL},
